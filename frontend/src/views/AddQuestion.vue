<template>
    <form>
        <div>
            ...
            <input v-model="questionToAdd.question" type="text" name="question" id="question" class="myInput">
        </div>
        <div>
            <label for="response1">Réponse 1</label>
            <input v-model="questionToAdd.response1" type="text" name="response1" id="response1" class="myInput"/>
        </div>
        <div>
            <label for="response2">Réponse 2</label>
            <input v-model="questionToAdd.response2" type="text" name="response2" id="response2" class="myInput"/>
        </div>
        <div>
            <label for="response3">Réponse 3</label>
            <input v-model="questionToAdd.response3" type="text" name="response3" id="response3" class="myInput"/>
        </div>
        <div>
            <label for="response4">Réponse 4</label>
            <input v-model="questionToAdd.response4" type="text" name="response4" id="response4" class="myInput"/>
        </div>
        <fieldset>
